...
public class LinePiece extends Tetromino{
	...
	public LinePiece(int x, int y) {
		...
		for(int i=0;i<4;i++) {
			switch(i) {
				case(0):Tile one=new Tile(x,y,3);
						tetromino.add(one);
				case(1):Tile two=new Tile(x-60,y,3);
						tetromino.add(two);
				case(2):Tile three=new Tile(x-30,y,3);
						tetromino.add(three);
				case(3):Tile four=new Tile(x+30,y,3);
						tetromino.add(four);
			}
