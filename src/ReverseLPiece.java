...
public class ReverseLPiece extends Tetromino{
	...
	public ReverseLPiece(int x, int y) {
		...
		for(int i=0;i<4;i++) {
			switch(i) {
				case(0):Tile one=new Tile(x,y,1);
						tetromino.add(one);
				case(1):Tile two=new Tile(x-30,y,1);
						tetromino.add(two);
				case(2):Tile three=new Tile(x+30,y,1);
						tetromino.add(three);
				case(3):Tile four=new Tile(x+30,30+y,1);
						tetromino.add(four);
			}
